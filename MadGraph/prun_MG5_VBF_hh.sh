...
rm tarball_SMVBF_hh_NoGenCuts.tar.gz
tar cvfz tarball_SMVBF_hh_NoGenCuts.tar.gz MG5_aMC_v2_6_6 run_MG5_SMVBF_hh.sh

prun --exec "run_MG5_SMVBF_hh.sh" --outDS user.${CERN_USER}.pp_VBFSM_hh_NoGenCuts.v2 --outputs unweighted_events.lhe --inTarBall tarball_SMVBF_hh_NoGenCuts.tar.gz --nJobs 1
